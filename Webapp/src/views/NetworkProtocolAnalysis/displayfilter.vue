...
const studentid = getCookie('studentId')
const uploadpath = ref<string>(`/${studentid}/10005/result.csv`)
...
const scoreCsv = async () => {
  ...
  try {
    // 调用评分API
    const commit = new Commit(0,studentid, 10005, 0, `studentsdata/${studentid}/10005/result.csv`, getCurrentTime(), false);
