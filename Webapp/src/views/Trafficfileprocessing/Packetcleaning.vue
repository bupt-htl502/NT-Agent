...
const studentid = getCookie('studentId')
const uploadpath = ref<string>(`/${studentid}/20002/result.csv`)
...
const scoreCsv = async () => {
  ...
  try {
    // 调用评分API
    const commit = new Commit(0,studentid, 20002, 0, `studentsdata/${studentid}/20002/result.csv`, getCurrentTime(), false);
