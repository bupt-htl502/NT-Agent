...
const documentUrl = ref("https://yu5fu9ktnt.feishu.cn/docx/LP7hd3AHcoKf46xYt6Bcx2VVnze?from=from_copylink");
...
const downZip = async () => {
  await downloadExperimentData(studentid as number, 20005);
};
