...
const documentUrl = ref("https://yu5fu9ktnt.feishu.cn/docx/BuUSdKva7ovrnTxYfomc0Ecznld?from=from_copylink");
...
const downZip = async () => {
  await downloadExperimentData(studentid as number, 20003); // 场景ID可动态传入
};
