            ...
            <div class="experiment-page">
                <el-table :data="tableData" class="experiment-table">
                    <el-table-column prop="name" label="特征字段" width="200">
                        <template #header><span style="color: black;">特征字段</span></template>
                    </el-table-column>
                    ...
                    <el-table-column width="150">
                        ...
                        <template #default="scope">
                            <el-tooltip class="box-item" effect="dark" content="点我获取提示信息！" placement="right-start">
                                <el-button style="border-style: none;" size="small" @click="hint(scope.$index, scope.row)">
                ...
                <div class="experiment-upload">
                    ...
                    <el-upload v-model:file-list="files" class="upload-demo experiment-upload-btn" action="">
