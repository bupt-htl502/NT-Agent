...
public class StudentMessageListener {
    ...
    public void registration(Student student) {
        ...
        List<Student2Resource> s2r = stream.map(id -> {
            try {
                List<Item> resultDatasets = minioMananger.getAllObjectsByPrefix("1111", String.format("/home/path/%d", id), false);
                List<Item> resultAnswers = minioMananger.getAllObjectsByPrefix("1111", String.format("/home/criterion/%d", id), false);
                ...
                student2Resource.setPath("/home/path" + dataset.objectName());
                student2Resource.setCriterion("/home/criterion" + answer.objectName());
